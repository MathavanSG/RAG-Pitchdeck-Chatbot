...
<<<<<<< HEAD
   ...
   The report should be in the below format and answer it based on the instruction associated with each topics.

   
   
   Answer each and every Topic in the format with exact datas do not make up stuffs
    <b>Introduction</b>
    • About the company:
    ...
    <b>Competitors</b>
        • Local Competitors:
            • Competitor 1: [Insert competitor name]
            • Competitor 2: [Insert competitor name]
            • Competitor 3: [Insert competitor name]
    ...
    <b>The Ideal Customer Profile (ICP)</b>
    • [Describe qualitatively and insert numerical data]

    <b>Ideal Customer Persona</b>
    • [Describe qualitatively and insert numerical data]

    <b>TAM SAM SOM Analysis</b>
    • [Describe qualitatively and insert numerical data]

    <b>Things to Improve</b>
    • Area 1: [Describe qualitatively]
        • Improvement strategy: [Describe qualitatively]
    • Area 2: [Describe qualitatively]
        • Improvement strategy: [Describe qualitatively]
    • Area 3: [Describe qualitatively]
        • Improvement strategy: [Describe qualitatively]
